...
app.post('/addAdminProductdetails',async(req,res,next)=>{
  ...
  if(!users){
    ...
    app.post('/addorders',async(req,res,next)=>{
      ...
      status=status+1;
      var {address}=req.body.adata;
      console.log(req.body.adata.fname);
      ...
      const newOrder = new order({
            ...
            status,
            address: {
                fname: req.body.adata.fname,
                lname: req.body.adata.lname,
                village: req.body.adata.village,
                country: req.body.adata.country,
                pincode: req.body.adata.pincode,
                city: req.body.adata.city,
                state: req.body.adata.state
            }
        });
              ...
              <body>
                <div class="container">
                  ...
                  <div class="content">
                    ...
                    <p>🎉 Congratulations! Your delicious ${req.body.productName} has been successfully delivered and is now ready for you to savor. We hope every bite brings you joy and satisfaction. Our chefs put their heart and soul into preparing your order, and we're thrilled to have served you today.  Thank you for choosing ${req.body.Company} for your culinary experience. If you have any feedback or need assistance, don't hesitate to reach out. Enjoy your meal! 🍽️"</p>
                    <p>Thank you for joining ${req.body.Company} community.</p>
                  </div>
                  <div class="footer">
                    <p>© 2024 manojkumar. All rights reserved.</p>
                  </div>
